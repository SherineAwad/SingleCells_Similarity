...
def main():
    ...
    csv_path = args.out.rsplit('.', 1)[0] + '_cosine_similarity.csv'
    sim_df.to_csv(csv_path)
    print(f"✓ Saved similarity matrix to: {csv_path}")

    # Save summary report
    report_path = args.out.rsplit('.', 1)[0] + '_cosine_report.txt'
    with open(report_path, 'w') as f:
        f.write("Cosine Similarity Report\n")
        f.write("===============================\n")
